...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        BitmapShader bitmapLogoShader = new BitmapShader(batmanLogo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);

        ComposeShader composeShader = new ComposeShader(bitmapShader, bitmapLogoShader, PorterDuff.Mode.DST_IN); //第一个参数是DEST
