...
public class Practice12PathEffectView extends View {
    ...
    DashPathEffect dashPathEffect = new DashPathEffect(new float[]{20f, 10, 5, 5}, 0);
...

    {
        ...
        sectionPath.lineTo(20, -30);
        sectionPath.lineTo(40, 0);
        sectionPath.close();
        pathDashPathEffect = new PathDashPathEffect(sectionPath, 50, 0, PathDashPathEffect.Style.MORPH);
    }
